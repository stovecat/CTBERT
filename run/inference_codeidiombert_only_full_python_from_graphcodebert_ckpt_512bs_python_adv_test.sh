...
cuda=$1
lang=python
path=../ckpt/codesearchnet/codeidiombert_only_full_python_from_graphcodebert_ckpt_512bs_$lang
init_path=../ckpt/pretrain/codeidiombert_only_full_python_from_graphcodebert_ckpt_512bs/checkpoint-last
