...
lang=$1
cuda=$2
path=../ckpt/codesearchnet/codeidiombert_none_python_from_graphcodebert_ckpt_40k_$lang
init_path=../ckpt/pretrain/codeidiombert_none_python_from_graphcodebert_ckpt_40k/checkpoint-last
