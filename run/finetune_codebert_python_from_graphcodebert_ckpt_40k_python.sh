...
lang=$1
cuda=$2
path=../ckpt/codesearchnet/codebert_python_from_graphcodebert_ckpt_40k_$lang
init_path=../ckpt/pretrain/codebert_python_from_graphcodebert_ckpt_40k/checkpoint-last
