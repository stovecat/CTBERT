...
lang=$1
cuda=$2
path=../ckpt/codesearchnet/codeidiombert_python_from_graphcodebert_ckpt_$lang
init_path=../ckpt/pretrain/codeidiombert_python_from_graphcodebert_ckpt/checkpoint-last
